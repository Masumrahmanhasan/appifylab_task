            ...
            <div className="_feed_inner_timeline_content _padd_r24 _padd_l24">
                ...
                {post.image_path && (
                    <div className="_feed_inner_timeline_image">
                        <Image width={500} height={500} src={post.image_path} alt="" className="_time_img" />
                    </div>
                )}
            </div>
            <div className="_feed_inner_timeline_total_reacts _padd_r24 _padd_l24 _mar_b26">
                ...
                <div className="_feed_inner_timeline_total_reacts_txt">
                    <p className="_feed_inner_timeline_total_reacts_para1">
                        <a href="#0"><span>{post.reactions?.comments || 0}</span> Comment</a>
                    </p>
                    <p className="_feed_inner_timeline_total_reacts_para2"><span>{post.reactions?.shares || 0}</span> Share</p>
                </div>
            </div>
                                    ...
                                    <div className="_comment_reply">
                                        <div className="_comment_reply_num">
                                            <ul className="_comment_reply_list">
                                                ...
                                                <li><span onClick={() => setReplyToCommentId(replyToCommentId === comment.id ? null : comment.id)} style={{ cursor: 'pointer' }}>Reply.</span></li>
                                                <li><span className="_time_link" suppressHydrationWarning>{new Date(comment.created_at).toLocaleString()}</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
